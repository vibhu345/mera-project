#responsible for running data ingestion,data transformation,model trainer
import sys
import os
...
class TrainingPipeline:
    ...
    def start_model_training(self,train_arr,test_arr):
        try:
            ...
            model_path,model_score=model_trainer.initiate_model_trainer(train_arr,test_arr)
            return model_score
        except Exception as e:
            raise CustomException(e,sys)
    def run_pipeline(self):
        try:
            ...
            print("training completed and trained model score is",r2_score)
        except Exception as e:
            raise CustomException(e,sys)
